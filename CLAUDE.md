...
4. **`scripts/regenerate-dialogues-33-43.js [--apply]`** — Rebuilds the reviewed synthetic rows for lesson units 33–43 with stable dialogue IDs.
...
└── regenerate-dialogues-33-43.js      Reviewed Unit 33–43 dialogue rebuild
```

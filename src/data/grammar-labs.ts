...
export const GRAMMAR_LABS: GrammarLab[] = [
  ...
  },
  {
    ...
    pattern: "o- + subject/object prefixes + explicit past stem",
    explanation:
      "Beginner guidance: completed actions use o- before the verb. Many verbs also change their stem in the past, so this lab practices explicit high-confidence forms instead of asking you to infer new stems.",
    examples: [
      {
        nahuatl: "Ōnihuetz.",
        breakdown: "ō-ni-huetz",
        translation: "I fell.",
        note: "o- marks completed action.",
      },
      {
        nahuatl: "Ōtihuetz.",
        breakdown: "ō-ti-huetz",
        translation: "You fell.",
        note: "The subject prefix comes after o-.",
      },
      {
        nahuatl: "Ōquicuac.",
        breakdown: "ō-qui-cua-c",
        translation: "She/he ate it.",
        note: "This is an explicit past form for kwa with an object prefix.",
      },
    ],
    drills: [
      {
        ...
        items: [
          {
            ...
            answer: "ōnihuetz",
            breakdown: "ō-ni-huetz",
            explanation: "Add o- before the subject prefix.",
          },
          {
            input: "tihuetz",
            target: "completed action",
            answer: "ōtihuetz",
            breakdown: "ō-ti-huetz",
            explanation: "The completed-action marker o- comes first.",
          },
          {
            input: "quicua",
            target: "completed action",
            answer: "ōquicuac",
            breakdown: "ō-qui-cua-c",
            explanation: "Use the explicit past form kwak with o- at the front.",
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            answer: "ōnihuetz",
            breakdown: "ō-ni-huetz",
            explanation: "Use o- before nihuetz.",
          },
          {
            english: "I came back.",
            answer: "ōnicuēp",
            breakdown: "ō-ni-cuēp",
            explanation: "This lab uses the explicit past form onikwep.",
          },
          {
            english: "She/he ate it.",
            answer: "ōquicuac",
            breakdown: "ō-qui-cua-c",
            explanation: "Use o- plus the explicit past transitive form kikwak.",
          },
        ],
      },
    ],

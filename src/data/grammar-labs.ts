...
export const GRAMMAR_LABS: GrammarLab[] = [
  ...
  },
  {
    ...
    pattern: "no-/mo-/i- + tokah",
    explanation:
      "In this lesson pattern, tokah is the conversational possessed-name stem. Add no- for “my,” mo- for “your,” and i- for “her/his.” Use notokah when you give your name. Use motokah when you ask someone their name.",
    examples: [
      {
        nahuatl: "Na notokah Juana.",
        breakdown: "na no-tokah Juana",
        translation: "My name is Juana.",
        note: "notokah means “my name.” The name comes after it.",
      },
      {
        nahuatl: "¿Kenihki motokah?",
        breakdown: "kenihki mo-tokah",
        translation: "What is your name?",
        note: "motokah means “your name.”",
      },
      {
        nahuatl: "Itokah María.",
        breakdown: "i-tokah María",
        translation: "Her/his name is María.",
        note: "i- means “her/his” in this possessed noun pattern.",
      },
      {
    ...
    drills: [
        ...
        items: [
          {
            prompt: "my name",
            answer: "notokah",
            explanation: "no- means “my,” so no-tokah means “my name.”",
          },
          {
            prompt: "your name",
            answer: "motokah",
            explanation: "mo- means “your,” so mo-tokah means “your name.”",
          },
          {
            prompt: "her/his name",
            answer: "itokah",
            explanation: "i- means “her/his,” so i-tokah means “her/his name.”",
          },
        ],
      },
      {
        kind: "paradigm",
        heading: "toka with possessors",
      ...
      },
      {
        ...
        prompt: "Use tokah “name” with the right possessor. For the first two, the target answer is one word.",
        items: [
          {
            input: "tokah",
            ...
            answer: "notokah",
            breakdown: "no-tokah",
            explanation: "Add no- to make notokah “my name.” In a full introduction, use Na notokah plus the name.",
            accepted: ["notoka", "notocah", "notōcah", "Na notoka", "Na notokah", "Na notōcah", "na notoka", "na notokah"],
          },
          {
            input: "tokah",
            ...
            answer: "motokah",
            breakdown: "mo-tokah",
            explanation: "Add mo- to make motokah “your name.” Use it in the question ¿Kenihki motokah?",
            accepted: ["motoka", "motocah", "motōcah", "Ta motoka", "Ta motokah", "Ta motōcah", "ta motoka", "ta motokah"],
          },
          {
            input: "Na notokah Juana.",
            target: "change the name to Ana",
            answer: "Na notokah Ana.",
            breakdown: "na no-tokah Ana",
            explanation: "Keep Na notokah and replace the personal name.",
            accepted: ["Na notoka Ana", "Na notōcah Ana", "Na notocah Ana"],
          },
          {
            input: "notokah",
            target: "ask “what is your name?”",
            answer: "¿Kenihki motokah?",
            breakdown: "kenihki mo-tokah",
            explanation: "Use motokah because you are asking for the other person’s name.",
            accepted: ["Kenihki motoka", "Tlen motoka", "Tlen motokah", "Quēniuhqui motōcah", "Queniuhqui motocah", "Kenijki motoka", "Kenijki motokah", "Keniki motoka", "Keniki motokah", "Kenin motoka", "Kenin motokah", "Kenikatsa motoka", "Kenikatsa motokah"],
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            answer: "Na notokah Juana.",
            breakdown: "na no-tokah Juana",
            explanation: "Use Na notokah, then the name.",
            accepted: ["Na notoka Juana", "Na notōcah Juana", "Na notocah Juana", "notoka Juana", "notokah Juana", "notōcah Juana"],
          },
          {
            english: "What is your name?",
            answer: "¿Kenihki motokah?",
            breakdown: "kenihki mo-tokah",
            explanation: "Use motokah because you are asking about “your name.”",
            accepted: ["Kenihki motoka", "Tlen motoka", "Tlen motokah", "Quēniuhqui motōcah", "Queniuhqui motocah", "Kenijki motoka", "Kenijki motokah", "Keniki motoka", "Keniki motokah", "Kenin motoka", "Kenin motokah", "Kenikatsa motoka", "Kenikatsa motokah"],
          },
          {
            ...
            answer: "Na notokah Ana.",
            breakdown: "na no-tokah Ana",
            explanation: "Keep the Unit 3 frame Na notokah and add the name.",
            accepted: ["Na notoka Ana", "Na notōcah Ana", "Na notocah Ana", "notoka Ana", "notokah Ana", "notōcah Ana"],
          },
          {
            english: "Her/his name is María.",
            answer: "Itokah María.",
            breakdown: "i-tokah María",
            explanation: "Use i- for “her/his,” then tokah and the name.",
            accepted: ["Itoka María", "Itōcah María", "Ītōcah María", "itōcah maria", "Itocah María"],
          },
          {
            english: "And you, what is your name?",
            answer: "Huan ta, ¿kenihki motokah?",
            breakdown: "huan ta, kenihki mo-tokah",
            explanation: "Huan ta means “and you”; motokah means “your name.”",
            accepted: ["Huan ta kenihki motoka", "Huan ta tlen motoka", "Huan ta tlen motokah", "Huan ta quēniuhqui motōcah", "huan ta quēniuhqui motōcah", "Huan ta kenijki motoka", "Huan ta kenijki motokah", "Huan ta keniki motoka", "Huan ta keniki motokah", "Huan ta kenin motoka", "Huan ta kenin motokah", "Huan ta kenikatsa motoka", "Huan ta kenikatsa motokah"],
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    explanation:
      "Beginner guidance: present intransitive verbs use subject prefixes. Singular forms are ni-, ti-, and zero prefix. Plural forms use ti-...-h, in-...-h, and zero-...-h. The same ti- can mean “you” or “we”; the final -h tells you the plural form.",
    examples: [
      {
        nahuatl: "Nitequiti.",
      ...
      {
        nahuatl: "Intequitih.",
        breakdown: "in-tequiti-h",
        translation: "You all work.",
        note: "in- plus -h marks second person plural in EHN.",
      },
    ],
    drills: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            answer: "intequitih",
            breakdown: "in-tequiti-h",
            explanation: "Second person plural uses in- at the front and -h at the end.",
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            answer: "intequitih",
            breakdown: "in-tequiti-h",
            explanation: "Use in- plus final -h for second person plural.",
          },
        ],
      },
    ],
  },
  {
    ...
    pattern: "no-/mo-/i-/to-/inmo-/inin- + noun stem",
    explanation:
    ...
    drills: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            accepted: ["motoka", "motōcah", "motocah"],
          },
          {
            input: "mīllah",
            target: "our milpa",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            accepted: ["intoka", "intōcah", "intocah"],
          },
        ],
      },
    ],
    ...
    drills: [
      {
        ...
        items: [
          ...
          },
          {
            input: "tlamachtia",
            target: "you all",
            answer: "intlamachtiah",
            breakdown: "in-tlamachtia-h",
            explanation: "Use in- plus final -h for second person plural.",
          },
        ],
      },
  ...
  },
  {
    ...
    explanation:
      "Beginner guidance: transitive verbs can mark a specific direct object inside the verb. This lab focuses on practical 3rd-person object forms k-/ki- with familiar verbs.",
    examples: [
      {
        nahuatl: "Niccua.",
        breakdown: "ni-c-cua",
        translation: "I eat it.",
        note: "ni- is the subject; k- is the object.",
      },
      {
        nahuatl: "Ticcua.",
        breakdown: "ti-c-cua",
        translation: "You eat it.",
        note: "ti- marks the subject and k- marks the object.",
      },
      {
        nahuatl: "Quicua.",
        breakdown: "qui-cua",
        translation: "She/he eats it.",
        note: "In third person subject forms, ki- marks the object here.",
      },
    ],
    drills: [
      {
        ...
        items: [
          {
            ...
            answer: "niccua",
            breakdown: "ni-c-cua",
            explanation: "ni- marks “I,” and k- marks the object “it.”",
          },
          {
            input: "ti- + c- + chīhua",
            target: "combine",
            ...
            explanation: "The subject prefix ti- comes before the object prefix k-.",
          },
          {
            input: "qui- + cua",
            ...
            answer: "quicua",
            breakdown: "qui-cua",
            explanation: "For this beginner pattern, ki- marks a 3rd-person object with a 3rd-person subject.",
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            answer: "niccua",
            breakdown: "ni-c-cua",
            explanation: "Use ni- for the subject and k- for the direct object.",
          },
          {
            english: "You make it.",
            answer: "ticchīhua",
            breakdown: "ti-c-chīhua",
            explanation: "Use ti- for “you” and k- for “it.”",
          },
          {
            english: "She/he eats it.",
            answer: "quicua",
            breakdown: "qui-cua",
            explanation: "Use the explicit 3rd-person object form ki- with kwa.",
          },
        ],
      },
    ],
  },
  {
    ...
    pattern: "subject/object prefixes + attested EHN preterite stem",
    explanation:
      "Beginner guidance: Eastern Huasteca completed actions use an attested preterite stem without the Classical o- augment. Many verbs change their stem, so this lab practices explicit source-course forms instead of asking you to infer new ones.",
    examples: [
      {
        nahuatl: "Nitequitqui.",
        breakdown: "ni-tequit-qui",
        translation: "I worked.",
        note: "-qui marks this attested EHN completed-action stem.",
      },
      {
        nahuatl: "Niyāhqui.",
        breakdown: "ni-yāh-qui",
        translation: "I went.",
        note: "This is the attested EHN went-form.",
      },
      {
        nahuatl: "Niccōuhqui.",
        breakdown: "ni-c-cōuh-qui",
        translation: "I bought it.",
        note: "This form is attested verbatim in the EHN source corpus.",
      },
    ],
    drills: [
      {
        ...
        items: [
          {
            ...
            answer: "nitequitqui",
            breakdown: "ni-tequit-qui",
            explanation: "Use the attested EHN preterite nitequitqui.",
          },
          {
            input: "niyāuh",
            target: "completed action",
            answer: "niyāhqui",
            breakdown: "ni-yāh-qui",
            explanation: "Use the attested EHN preterite niyāhqui.",
          },
          {
            input: "niccōhua",
            target: "completed action",
            answer: "niccōuhqui",
            breakdown: "ni-c-cōuh-qui",
            explanation: "Use the attested EHN preterite niccōuhqui.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    pattern: "tlan + condition, result",
    explanation:
      "Beginner guidance: EHN tlan means “if.” This lab practices short sentences where both clauses use forms you already know. The goal is to combine clauses clearly, not to create complex hypothetical grammar.",
    examples: [
      {
        ...
        items: [
          {
            ...
            answer: "Tlan nitequiti, nitlacua.",
            breakdown: "tlan ni-tequiti, ni-tlacua",
            explanation: "Place tlan before the condition, then give the result after the comma.",
            accepted: ["Tlan nitequiti nitlacua", "tlan nitequiti, nitlacua"],
          },
          {
            input: "tiyāuh + niyāuh",
            target: "if you go, I go",
            answer: "Tlan tiyāuh, niyāuh.",
            breakdown: "tlan ti-yāuh, ni-yāuh",
            explanation: "Each clause keeps its own subject prefix.",
            accepted: ["Tlan tiyāuh niyāuh", "tlan tiyāuh, niyāuh"],
          },
          {
            input: "tequitih + titequitih",
            target: "if they work, we work",
            answer: "Tlan tequitih, titequitih.",
            breakdown: "tlan tequiti-h, ti-tequiti-h",
            explanation: "The condition uses tequitih, and the result uses titequitih.",
            accepted: ["Tlan tequitih titequitih", "tlan tequitih, titequitih"],
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            answer: "Tlan nitequiti, nitlacua.",
            breakdown: "tlan ni-tequiti, ni-tlacua",
            explanation: "Use tlan before the condition nitequiti.",
            accepted: ["Tlan nitequiti nitlacua", "tlan nitequiti, nitlacua"],
          },
          {

...
export const GRAMMAR_LABS: GrammarLab[] = [
  ...
  },
  {
    ...
    pattern: "no-/mo-/i- + toka",
    explanation:
      "In this lesson pattern, toka is the conversational possessed-name stem. Add no- for “my,” mo- for “your,” and i- for “her/his.” Use notoka when you give your name. Use motoka when you ask someone their name.",
    examples: [
      {
        nahuatl: "Na notoka Juana.",
        breakdown: "na no-toka Juana",
        translation: "My name is Juana.",
        note: "notoka means “my name.” The name comes after it.",
      },
      {
        nahuatl: "¿Kenihki motoka?",
        breakdown: "kenihki mo-toka",
        translation: "What is your name?",
        note: "motoka means “your name.”",
      },
      {
        nahuatl: "Itoka María.",
        breakdown: "i-toka María",
    ...
    drills: [
        ...
        items: [
          {
            prompt: "my name",
            answer: "notoka",
            explanation: "no- means “my,” so no-toka means “my name.”",
          },
          {
            prompt: "your name",
            answer: "motoka",
            explanation: "mo- means “your,” so mo-toka means “your name.”",
          },
          {
            prompt: "her/his name",
            answer: "itoka",
            explanation: "i- means “her/his,” so i-toka means “her/his name.”",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        prompt: "Use toka “name” with the right possessor. For the first two, the target answer is one word.",
        items: [
          {
            input: "toka",
            ...
            answer: "notoka",
            breakdown: "no-toka",
            explanation: "Add no- to make notoka “my name.” In a full introduction, use Na notoka plus the name.",
            accepted: ["notocah", "notokah", "notōcah", "Na notoka", "Na notōcah", "na notoka"],
          },
          {
            input: "toka",
            ...
            answer: "motoka",
            breakdown: "mo-toka",
            explanation: "Add mo- to make motoka “your name.” Use it in the question ¿Kenihki motoka?",
            accepted: ["motocah", "motokah", "motōcah", "Ta motoka", "Ta motōcah", "ta motoka"],
          },
          {
            input: "Na notoka Juana.",
            target: "change the name to Ana",
            answer: "Na notoka Ana.",
            breakdown: "na no-toka Ana",
            explanation: "Keep Na notoka and replace the personal name.",
            accepted: ["Na notōcah Ana", "Na notocah Ana", "Na notokah Ana"],
          },
          {
            input: "notoka",
            target: "ask “what is your name?”",
            answer: "¿Kenihki motoka?",
            breakdown: "kenihki mo-toka",
            explanation: "Use motoka because you are asking for the other person’s name.",
            accepted: ["Tlen motoka", "Quēniuhqui motōcah", "Queniuhqui motocah", "Kenijki motoka", "Keniki motoka", "Kenin motoka", "Kenikatsa motoka"],
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            answer: "Na notoka Juana.",
            breakdown: "na no-toka Juana",
            explanation: "Use Na notoka, then the name.",
            accepted: ["Na notōcah Juana", "Na notocah Juana", "Na notokah Juana", "notoka Juana", "notōcah Juana"],
          },
          {
            english: "What is your name?",
            answer: "¿Kenihki motoka?",
            breakdown: "kenihki mo-toka",
            explanation: "Use motoka because you are asking about “your name.”",
            accepted: ["Tlen motoka", "Quēniuhqui motōcah", "Queniuhqui motocah", "Kenijki motoka", "Keniki motoka", "Kenin motoka", "Kenikatsa motoka"],
          },
          {
            ...
            answer: "Na notoka Ana.",
            breakdown: "na no-toka Ana",
            explanation: "Keep the Unit 3 frame Na notoka and add the name.",
            accepted: ["Na notōcah Ana", "Na notocah Ana", "Na notokah Ana", "notoka Ana", "notōcah Ana"],
          },
          {
            english: "Her/his name is María.",
            answer: "Itoka María.",
            breakdown: "i-toka María",
            explanation: "Use i- for “her/his,” then toka and the name.",
            accepted: ["Itōcah María", "Ītōcah María", "itōcah maria", "Itocah María", "Itokah María"],
          },
          {
            english: "And you, what is your name?",
            answer: "Huan ta, ¿kenihki motoka?",
            breakdown: "huan ta, kenihki mo-toka",
            explanation: "Huan ta means “and you”; motoka means “your name.”",
            accepted: ["Huan ta tlen motoka", "Huan ta quēniuhqui motōcah", "huan ta quēniuhqui motōcah", "Huan ta kenijki motoka", "Huan ta keniki motoka", "Huan ta kenin motoka", "Huan ta kenikatsa motoka"],
          },
        ],
      },
    ],
    ...
    drills: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            accepted: ["motōcah", "motocah", "motokah"],
          },
          {
            input: "mīllah",
            target: "our milpa",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            accepted: ["intōcah", "intocah", "intokah"],
          },
        ],
      },
    ],

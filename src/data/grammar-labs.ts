...
export const GRAMMAR_LABS: GrammarLab[] = [
  ...
  },
  {
    ...
    unit: 3,
    band: "A1",
    title: "Say “I Am...” in Introductions",
    shortDesc: "Build intro sentences like “I am Mexican” with the Unit 3 identity word mexikatl.",
    pattern: "ni-/ti-/no prefix + identity word",
    explanation:
      "In this beginner pattern, the prefix carries the meaning of “I am” or “you are.” Use ni- for “I am,” ti- for “you are,” and no prefix for “she/he is.” Do not add a separate word for “am” or “is.”",
    examples: [
      {
        nahuatl: "Na nimexikatl.",
        breakdown: "na ni-mexikatl",
        translation: "I am Mexican.",
        note: "na adds emphasis; ni- attached to mexikatl carries “I am.”",
      },
      {
        nahuatl: "Ta timexikatl.",
        breakdown: "ta ti-mexikatl",
        translation: "You are Mexican.",
        note: "ta adds emphasis; ti- attached to mexikatl carries “you are.”",
      },
      {
        nahuatl: "Ya mexikatl.",
        breakdown: "ya mexikatl",
        translation: "She/he is Mexican.",
    ...
    drills: [
      {
        kind: "paradigm",
        heading: "mexikatl in introductions",
        prompt: "Read the three intro forms before typing your own.",
        rows: [
          {
            cue: "I",
            answer: "nimexikatl",
            breakdown: "ni-mexikatl",
            translation: "I am Mexican.",
          },
          {
            cue: "you",
            answer: "timexikatl",
            breakdown: "ti-mexikatl",
            translation: "You are Mexican.",
          },
          {
            cue: "she/he",
      ...
      },
      {
        ...
        prompt: "Keep mexikatl and change the prefix for the new meaning.",
        items: [
          {
            input: "mexikatl",
            target: "make it “I am Mexican”",
            answer: "nimexikatl",
            breakdown: "ni-mexikatl",
            explanation: "Add ni- to mexikatl. The ni- prefix supplies “I am.”",
            accepted: ["na nimexikatl"],
          },
          {
            input: "mexikatl",
            target: "make it “you are Mexican”",
            answer: "timexikatl",
            breakdown: "ti-mexikatl",
            explanation: "Add ti- to mexikatl. The ti- prefix supplies “you are.”",
            accepted: ["ta timexikatl"],
          },
          {
            input: "nimexikatl",
            target: "make it “she/he is Mexican”",
            answer: "mexikatl",
            breakdown: "mexikatl",
            explanation: "Remove ni-. Third person singular has no added prefix in this beginner pattern.",
            accepted: ["ya mexikatl"],
          },
        ],
      },
      {
        kind: "produce",
        heading: "Type the intro sentence",
        prompt: "Use mexikatl and the correct prefix. Type only the Nahuatl answer.",
        items: [
          {
            english: "I am Mexican.",
            answer: "nimexikatl",
            breakdown: "ni-mexikatl",
            explanation: "Use ni- for “I am,” then mexikatl.",
            accepted: ["na nimexikatl"],
          },
          {
            english: "You are Mexican.",
            answer: "timexikatl",
            breakdown: "ti-mexikatl",
            explanation: "Use ti- for “you are,” then mexikatl.",
            accepted: ["ta timexikatl"],
          },
          {
            english: "She/he is Mexican.",
            answer: "mexikatl",
            breakdown: "mexikatl",
            explanation: "For she/he, use mexikatl with no added subject prefix.",
            accepted: ["ya mexikatl"],
          },
        ],
      },

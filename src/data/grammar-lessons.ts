...
export const GRAMMAR_LESSONS: GrammarLesson[] = [
...

  {
    ...
    sections: [
      {
        kind: 'prose',
        text: `If you look up a Nahuatl word in three different books you may find it spelled several different ways: *cualli*, *kualli*, *kuali*, or *kwalli*. These refer to the same word ("good"). The difference isn't dialect — it's orthography. Nahuatl has never had a single official writing system, and several competing conventions coexist today.`,
      },
      {
        kind: 'rule',

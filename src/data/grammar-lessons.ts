    ...
    sections: [
      ...
      },
      {
        ...
        rows: [
          ...
          { person: 'kw', form: '/kw/', gloss: 'kwahtli — eagle' },
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        text: `The structure is: **[subject prefix] + [object prefix] + [verb stem]**\n\nFor example:\n• ni· + k· + kwa = nikkwa (I eat it)\n• ti· + k· + kwa = tikkwa (you eat it)\n• ki· + kwa = kikkwa (he/she eats it)\n\nThe object prefix *k-/ki-* means "it/him/her" (3rd person singular object). It has two learner-facing shapes: **k-** in forms like nikkwa and tikkwa, and **ki-** in third-person forms like kikkwa.`,
      },
      {
        kind: 'paradigm',
        ...
        rows: [
          ...
          { person: 'ki- / k-', form: 'him / her / it', gloss: 'kikkwa — he/she eats it; nikkwa — I eat it' },
          { person: 'tech-', form: 'us', gloss: 'techmaka — he/she gives us' },
          { person: 'amech-', form: 'you all', gloss: 'amechmaka — he/she gives you all' },
      ...
      },
      {
        ...
        text: `When subject and object prefixes combine, contractions can occur:\n• ni- + k- → **nik-** (I + it): nikkwa (I eat it), nikamati (I like it)\n• ti- + k- → **tik-**: tikkwa (you eat it), tiktlahtoa (you speak it)\n• ti- + k- + ... + -h (1pl) → **tikk-**: tikkwahkwepah (we cultivate it)\n\nWhen the subject is 3rd person and the object is 3rd person, the beginner form with a singular object is **ki-**: kikkwa (he/she eats it), kichihua (he/she makes it). Learn plural-object forms as explicit vocabulary examples before producing them freely.`,
      },
      {
        kind: 'paradigm',
    ...
    sections: [
      ...
      },
      {
        ...
        rows: [
          ...
          { person: 'maka (to give)',    form: 'makilia',   gloss: 'nechmakilia — s/he gives it to me (polite)' },
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        text: `1. **Tense prefix (optional)**: o- for past tense. Present and future use no prefix here.\n\n2. **Subject prefix**: ni- (I), ti- (you), nothing (he/she), ti-…-h (we), an-…-h (you all), …-h (they). For commands, xi- replaces the subject prefix.\n\n3. **Object prefix (optional)**: k-/ki- (him/her/it), nech- (me), mits- (you), tech- (us), mo- (reflexive "self"), tla- (something unspecified). Only present when the verb is transitive (acts on something).\n\n4. **Verb root**: The core meaning — tekiti (work), kwa (eat), machtia (teach), etc.\n\n5. **Tense/plural suffix**: -s (future singular), -skeh (future plural), -h (present plural), -keh (past plural). Present singular has no suffix.`,
      },
      {
        kind: 'examples',
    ...
    sections: [
      ...
      },
      {
        ...
        rows: [
          ...
          { person: 'he / she', form: 'kikkwa', gloss: 'he/she eats it' },
          { person: 'we', form: 'tikkwah', gloss: 'we eat it' },
          { person: 'they', form: 'kikkwah', gloss: 'they eat it' },
        ],
      },
      {
        kind: 'paradigm',
        ...
        rows: [
          ...
          { person: 'he / she', form: 'kikkwas', gloss: 'he/she will eat it' },
          { person: 'we', form: 'tikkwaskeh', gloss: 'we will eat it' },
          { person: 'they', form: 'kikkwaskeh', gloss: 'they will eat it' },
        ],
      },
      {
        kind: 'paradigm',
        ...
        headers: ['Person', 'Form', 'Meaning'],
        rows: [
          { person: 'I', form: 'onikkwak', gloss: 'I ate it' },
          { person: 'you', form: 'otikkwak', gloss: 'you ate it' },
          { person: 'he / she', form: 'okikwak', gloss: 'he/she ate it' },
          { person: 'we', form: 'otikkwakeh', gloss: 'we ate it' },
          { person: 'they', form: 'okikwakeh', gloss: 'they ate it' },
        ],
      },
      {
        kind: 'rule',
        title: 'Pattern summary',
        text: `Once you know one conjugation, you know the pattern. The formula is always:\n\n**[o- past] + [subject: ni-/ti-/an-/ø] + [object: k-/ki-] + [root] + [tense: -s/-skeh/-k/-keh] + [plural: -h]**\n\nMost irregularity comes from stem changes in the past tense (e.g. kwa → kwak, yauh → yak). The prefix/suffix pattern stays the same.`,
      },
    ],
  },

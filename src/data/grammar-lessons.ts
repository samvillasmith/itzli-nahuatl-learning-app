...
export const GRAMMAR_LESSONS: GrammarLesson[] = [
  {
    ...
    sections: [
      ...
      },
      {
        kind: 'rule',
        title: 'Vowels',
        text: `EHN has four vowel qualities in the practical spelling: a, e, i, o. Some source systems mark long vowels with macrons, but this app keeps learner-facing spelling plain. Listen to the audio and repeat the rhythm rather than trying to type vowel-length marks.`,
      },
      {
        kind: 'paradigm',
        heading: 'Vowels',
      ...
      },
      {
        ...
        rows: [
          ...
          { person: 'ts', form: '/ts/ (like "ts" in cats)', gloss: 'tsahtsi — to shout' },
          { person: 'x', form: '/ʃ/ (like "sh")', gloss: 'xochitl — flower' },
          { person: 'w', form: '/w/', gloss: 'weyi — big' },
          { person: 'kw', form: '/kw/', gloss: 'kwawtli — eagle' },
          { person: 'k', form: '/k/', gloss: 'kemman — when' },
          { person: 'h', form: 'glottal stop / h-like catch', gloss: 'axkan — today/now' },
        ],
      },
      {
        kind: 'rule',
        title: 'Stress',
        text: `Stress in EHN falls on the second-to-last (penultimate) syllable in most words. For example: ni·tla·mach·**ti**·a → stress on -ti-. In practice, you will acquire stress naturally through the dialogue exercises.`,
      },
      {
        kind: 'examples',
...

  {
    ...
    sections: [
      {
        kind: 'prose',
        text: `If you look up a Nahuatl word in three different books you may find it spelled several different ways: *cualli*, *kualli*, *kuali*, or *kwali*. These refer to the same word ("good"). The difference isn't dialect — it's orthography. Nahuatl has never had a single official writing system, and several competing conventions coexist today.`,
      },
      {
        kind: 'rule',
      ...
      {
        kind: 'prose',
        heading: 'Why this course uses INALI-style spelling',
        text: `The practical INALI spelling is easier to type, easier to search, and closer to what many learners will encounter in modern community and school contexts. It avoids macrons and the older c/qu/hu/cu conventions, so learners can focus on listening, speaking, and building sentences.\n\nThe underlying source data still includes IDIEZ-style forms so audio, images, attribution, and database lookups keep working. The app converts learner-facing Nahuatl into the practical spelling at display and answer-check time.`,
      },
      {
        kind: 'paradigm',
        heading: 'Quick conversion cheatsheet',
        caption: 'Mapping between older spellings and the learner-facing INALI-style display.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            nahuatl: 'Pan tomīllah ticcuahcuepah etl huan chilli huan cīntli.',
    ...
    sections: [
      ...
      },
      {
        ...
        rows: [
          ...
          { person: 'you all', form: 'in·tequiti·h', gloss: 'you all work' },
          { person: 'they', form: 'tequiti·h', gloss: 'they work' },
        ],
      },
      {
        kind: 'rule',
        title: 'Key pattern: ni- / ti- / (ø) / ti-...-h / in-...-h / (ø)-...-h',
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        text: `The verb stem is the core of the word. In dictionary entries, verbs are often listed without the prefix. To conjugate, attach the correct EHN prefix:\n\n• 1sg: **ni-** + stem\n• 2sg: **ti-** + stem\n• 3sg: stem alone\n• 1pl: **ti-** + stem + **-h**\n• 2pl: **in-** + stem + **-h**\n• 3pl: stem + **-h**`,
      },
      {
        kind: 'paradigm',
        ...
        rows: [
          ...
          { person: 'you all', form: 'intequitih', gloss: 'you all work' },
    ...
    sections: [
      ...
      },
      {
        ...
        rows: [
          ...
          { person: 'you all', form: 'inmo-', gloss: 'your (plural)' },
      ...
      },
      {
        ...
        items: [
          ...
          {
            nahuatl: 'Pan tomīllah ticcuahcuepah etl huan chilli.',
    ...
    sections: [
      ...
      },
      {
        ...
        rows: [
          ...
          { person: '¿Akkia?', form: 'Who?', gloss: 'people, subjects (source spelling: Ācquiya)' },
          { person: '¿Kampa? / ¿Kanke?', form: 'Where?', gloss: 'location' },
          { person: '¿Kenihki?', form: 'How? / What is … like?', gloss: 'manner, description' },
          { person: '¿Keman?', form: 'When?', gloss: 'time' },
          { person: '¿Keski?', form: 'How many?', gloss: 'quantity' },
          { person: '¿Ken?', form: 'How? (shortened)', gloss: 'manner (informal)' },
        ],
      },
      {
        kind: 'rule',
    ...
    sections: [
      ...
      },
      {
        ...
        rows: [
          ...
          { person: 'you all', form: 'intequitizqueh', gloss: 'you all will work' },
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        text: `The structure is: **[subject prefix] + [object prefix] + [verb stem]**\n\nFor example:\n• ni· + k· + kwa = nikkwa (I eat it)\n• ti· + k· + kwa = tikkwa (you eat it)\n• ki· + kwa = kikwa (he/she eats it)\n\nThe object prefix *k-/ki-* means "it/him/her" (3rd person singular object). It has two learner-facing shapes: **k-** in forms like nikkwa and tikkwa, and **ki-** in third-person forms like kikwa.`,
      },
      {
        kind: 'paradigm',
        ...
        rows: [
          { person: 'nech-', form: 'me', gloss: 'nechmaka — he gives me (something)' },
          { person: 'mits-', form: 'you (sg)', gloss: 'mitstemoa — I look for you' },
          { person: 'ki- / k-', form: 'him / her / it', gloss: 'kikwa — he/she eats it; nikkwa — I eat it' },
          { person: 'tech-', form: 'us', gloss: 'techmaka — he/she gives us' },
          { person: 'mech-', form: 'you all', gloss: 'mechmaka — he/she gives you all' },
          { person: 'kin-', form: 'them', gloss: 'kinmaka — he/she gives them' },
        ],
      },
      {
        kind: 'rule',
        title: 'Combining subject + object prefixes',
        text: `When subject and object prefixes combine, contractions can occur:\n• ni- + k- → **nik-** (I + it): nikkwa (I eat it), nikamati (I like it)\n• ti- + k- → **tik-**: tikkwa (you eat it), tiktlahtoa (you speak it)\n• ti- + k- + ... + -h (1pl) → **tikk-**: tikkwahkwepah (we cultivate it)\n\nWhen the subject is 3rd person and the object is 3rd person, the beginner form with a singular object is **ki-**: kikwa (he/she eats it), kichihua (he/she makes it). Learn plural-object forms as explicit vocabulary examples before producing them freely.`,
      },
      {
        kind: 'paradigm',
      ...
      },
      {
        ...
        items: [
          ...
          {
            nahuatl: 'Nitlaxcaloa.',
            breakdown: 'Ni·tlaxcaloa.',
            translation: 'I am making tortillas.',
            note: 'The tortilla noun is incorporated into the verb, so no object prefix is added.',
          },
          {
...

  {
    ...
    band: 'A2',
    shortDesc: 'Expressing completed past actions with EHN -qui/-c preterite forms.',
    relatedUnits: [14, 15, 16],
    relatedGrammarLabIds: ['past-tense'],
    sections: [
      {
        kind: 'prose',
        text: `The Eastern Huasteca Nahuatl preterite marks completed actions. Unlike Classical Nahuatl, the source-course variety does not use an **ō-** augment. Learn the attested past stem of each verb; common singular endings include **-qui / -c**, with **-queh** in many plural forms.`,
      },
      {
        kind: 'rule',
        title: 'Structure: [subject prefix] + [EHN past stem] + (-queh for plural)',
        text: `The subject prefix stays at the front and the verb takes its Eastern Huasteca past form:\n\n• ni·tlacuāh·qui = I ate\n• ni·c·cōuh·qui = I bought it\n• ni·yāh·qui = I went\n\nPast stems are not fully predictable, so learn them from attested source-course examples rather than adding a Classical **ō-** prefix.`,
      },
      {
        kind: 'paradigm',
        heading: 'Past tense examples — tequiti (to work)',
        headers: ['Person', 'Past form', 'Meaning'],
        rows: [
          { person: 'I', form: 'nitequitqui', gloss: 'I worked' },
          { person: 'you', form: 'titequitqui', gloss: 'you worked' },
          { person: 'he / she', form: 'tequitqui', gloss: 'he/she worked' },
          { person: 'we', form: 'titequitqueh', gloss: 'we worked' },
          { person: 'you all', form: 'intequitqueh', gloss: 'you all worked' },
          { person: 'they', form: 'tequitqueh', gloss: 'they worked' },
        ],
      },
      {
        kind: 'paradigm',
        ...
        rows: [
          { person: 'niyāhqui', form: 'yāuh (to go)', gloss: 'I went' },
          { person: 'nitlacuāhqui', form: 'tlacua (to eat)', gloss: 'I ate' },
          { person: 'niccōuhqui', form: 'cōhua (to buy)', gloss: 'I bought it' },
          { person: 'nichōcac', form: 'chōca (to cry)', gloss: 'I cried' },
          { person: 'nicchīuhqui', form: 'chīhua (to make)', gloss: 'I made it' },
          { person: 'nimomauhtihqui', form: 'momauhtia (to be afraid)', gloss: 'I was afraid' },
        ],
      },
      {
        kind: 'examples',
        ...
        items: [
          {
            nahuatl: 'Axcanah cuālli. Niyāhqui pan ohtli.',
            breakdown: 'Axcanah cuālli. Ni·yāh·qui pan ohtli.',
            translation: 'Not good. I went on the road.',
            note: 'ni- = 1sg; yāhqui = went; no Classical ō- augment',
          },
          {
            nahuatl: '¿Ax timomauhtihqui?',
            breakdown: '¿Ax ti·mo·mauhti·hqui?',
            translation: "Weren't you afraid?",
            note: 'ax = negation; ti- = 2sg; momauhtihqui = was afraid',
          },
          {
            nahuatl: 'Axcanah. Niyāhqui nicān.',
            breakdown: 'Axcanah. Ni·yāh·qui nicān.',
            translation: 'No. I went here.',
            note: 'axcanah = no/not; niyāhqui = I went',
          },
          {
            nahuatl: '¿Tlen ticchīuhqui?',
            breakdown: '¿Tlen ti·c·chīuh·qui?',
            translation: 'What did you make?',
            note: 'ticchīuhqui is an EHN preterite without an ō- augment',
          },
          {
            nahuatl: 'Cuālli niitztoc āxcan.',
            breakdown: 'Cuālli ni·itztoc āxcan.',
            translation: "I'm fine now.",
            note: 'niitztoc expresses being located or in a state; āxcan = now',
          },
        ],
      },
    ],
...

  {
    ...
    sections: [
      {
        kind: 'prose',
        text: `The standard negator in the Eastern Huasteca source course is **axcanah**, with a shorter **ax-** form before the word being negated. **Āmo** is retained chiefly in prohibitions such as *Āmo xichoca* (“Don't cry”), not as the default declarative negator.`,
      },
      {
        kind: 'paradigm',
        ...
        rows: [
          { person: 'axcanah', form: 'no / not — standard EHN negator', gloss: 'Axcanah nitlacua. — I am not eating.' },
          { person: 'ax- (short form)', form: 'not — before the negated word', gloss: "ax nicān — not here; ax quipiya — doesn't have it" },
          { person: 'āmo', form: 'prohibitive “don’t”', gloss: 'Āmo xichoca. — Don’t cry.' },
          { person: 'ax nelli', form: '"not true" / "that\'s not right"', gloss: 'Ax nelli. — That\'s not true.' },
          { person: 'axtlen', form: 'nothing', gloss: 'Axtlen nicpiya. — I have nothing.' },
        ],
      },
      {
        kind: 'rule',
        title: 'axcanah, ax, and prohibitive āmo',
        text: `• **axcanah** is the normal full negator and standalone “no” in the source-course variety.\n\n• **ax** is its shorter form and precedes the negated word: *ax nicān* (not here), *ax quipiya* (he/she doesn't have it).\n\n• **āmo** is useful in negative commands: *Āmo xiyāuh* (don't go).`,
      },
      {
        kind: 'examples',
        ...
        items: [
          {
            ...
            breakdown: 'Axcanah, āxcan ni·nēhnemi pan āltepētl.',
            translation: 'No, today I am walking around town.',
            note: 'Axcanah = "No" as a standalone denial',
          },
          {
            nahuatl: 'Ax cuālli.',
            breakdown: 'Ax cuālli.',
          ...
          },
          {
            ...
            breakdown: 'Neca i·axca no·cniuh. Ax to·axca.',
            translation: "That belongs to my friend. It is not ours.",
            note: 'Ax toaxca = literally "not our possession"',
          },
          {
            nahuatl: 'Axcanah. Cuālli niitztoc āxcan.',
            breakdown: 'Axcanah. Cuālli ni·itztoc āxcan.',
            translation: "No. I'm fine now.",
            note: 'Axcanah as denial; niitztoc expresses the current state',
          },
        ],
      },
    ],
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        text: `The applicative suffix **-lia** is added to a verb stem and creates a version of the verb that takes one extra object — the beneficiary, the person the action is done for. The beneficiary is marked with an object prefix (nech-, mits-, etc.) on the front of the verb.\n\nFormation:\n• Verbs ending in a vowel: drop the final vowel, add -lia\n• Verbs ending in -oa: -oa → -alhuia\n• Verbs ending in -ia: -ia → -ilia\n\nExamples:\n• chihua (to make) → chihuilia (to make for): *Nech·chihuilia se tlaxkali.* = "She makes a tortilla for me."\n• kwa (to eat) → kwalia (to eat up at someone's expense): *Nech·kwalia notlakwal.* = "He eats up my food on me."\n• tlahtoa (to speak) → tlahtalhuia (to speak to / on behalf of): *Mits·tlahtalhuia.* = "He speaks on your behalf."`,
      },
      {
        kind: 'paradigm',
        ...
        rows: [
          { person: 'chihua (to make)',  form: 'chihuilia',  gloss: 'nechchihuilia — s/he makes it for me' },
          { person: 'kohua (to buy)',    form: 'kohuilia',   gloss: 'mitskohuilia — s/he buys it for you' },
          { person: 'piki (to wrap)',   form: 'pikilia',   gloss: 'nechpikilia — s/he wraps it for me' },
          { person: 'tlahkwiloa (to write)', form: 'tlahkwilhuia', gloss: 'nechtlahkwilhuia — s/he writes to me' },
          { person: 'maka (to give)',    form: 'maka',      gloss: 'nechmaka — s/he gives it to me' },
          { person: 'ihtoa (to say)',    form: 'ilhuia',     gloss: 'nechilhuia — s/he says it to me / tells me' },
        ],
      },
      {
        kind: 'rule',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            note: 'xi- = imperative; nēch- = me; ilhui = tell (applicative of ihtoa)',
          },
          {
...

  {
    ...
    sections: [
      {
        kind: 'prose',
        text: `To give a command, make a polite request, or extend an invitation, EHN uses the **imperative prefix xi-** on the verb. The imperative replaces the usual subject prefix — you don't say both. Imperatives exist for 2sg ("do it!") and 2pl ("do it, all of you!"). There is also an optative form using **mā** for "let X happen" or "may X do it".`,
      },
      {
        kind: 'rule',
      ...
      },
      {
        ...
        rows: [
          ...
          { person: 'mā tihuāllācān',           form: 'may we come / let us come', gloss: '1pl hortative with -cān' },
      ...
      },
      {
        ...
        items: [
          ...
          {
            nahuatl: 'Xitlazohcamatican!',
            breakdown: 'Xi·tlazohcamati·can!',
            translation: 'Give thanks, all of you!',
            note: 'Plural imperative with -can',
          },
          {
    ...
    sections: [
      ...
      },
      {
        ...
        rows: [
          ...
          { person: '2pl', form: 'you all', gloss: 'in- … -h' },
    ...
    sections: [
      ...
      },
      {
        ...
        rows: [
          ...
          { person: 'nitequitqui', form: 'ni- + tequit- + -qui', gloss: 'I worked (past)' },
          { person: 'titequitih', form: 'ti- + tequiti + -h', gloss: 'we work' },
          { person: 'intequitizqueh', form: 'in- + tequiti + -zqueh', gloss: 'you all will work' },
      ...
      },
      {
        ...
        text: `1. **Subject prefix**: ni- (I), ti- (you), nothing (he/she), ti-…-h (we), in-…-h (you all), …-h (they). For commands, xi- replaces the subject prefix.\n\n2. **Object prefix (optional)**: k-/ki- (him/her/it), nech- (me), mits- (you), tech- (us), mech- (you all), mo- (reflexive "self"), tla- (something unspecified). Only present when the verb is transitive.\n\n3. **Verb root**: The core meaning — tekiti (work), kwa (eat), machtia (teach), etc.\n\n4. **Tense/plural suffix**: -s (future singular), -skeh (future plural), -h (present plural), and an attested EHN preterite such as -qui/-c or plural -queh. Present singular has no suffix.`,
      },
      {
        kind: 'examples',
        ...
        items: [
          ...
          {
            nahuatl: 'Tikchihua in tlakwali.',
            breakdown: 'ti- (you) + k- (it) + chihua (make) = you make it',
            translation: 'You are making the food.',
            note: 'Subject + object + root — present transitive',
          },
          {
            nahuatl: 'Okikwak in tamali.',
            breakdown: 'o- (past) + ki- (it) + kwa-k (eat-past) = he ate it',
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        rows: [
          { person: '-co', form: 'in / at (a contained place)', gloss: 'Mexihco (in Mexico), ātoyaco (at the river)' },
      ...
      },
      {
        ...
        rows: [
          { person: 'Mexihco', form: 'Mexih- + -co', gloss: 'Mexico (traditional place name; etymology is disputed)' },
      ...
      },
      {
        ...
        items: [
          ...
          {
            nahuatl: 'Pan tomīllah ticcuahcuepah etl.',
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        text: `When the verb takes an object, the object prefix (k-/ki-) appears between the subject prefix and the verb root. Below is kwa conjugated with a 3rd-person singular object ("it").`,
      },
      {
        kind: 'paradigm',
        heading: 'kwa (to eat it) — Present',
        headers: ['Person', 'Form', 'Meaning'],
        rows: [
          { person: 'I', form: 'nikkwa', gloss: 'I eat it' },
          { person: 'you', form: 'tikkwa', gloss: 'you eat it' },
          { person: 'he / she', form: 'kikwa', gloss: 'he/she eats it' },
          { person: 'we', form: 'tikkwah', gloss: 'we eat it' },
          { person: 'they', form: 'kikwah', gloss: 'they eat it' },
        ],
      },
      {
        kind: 'paradigm',
        heading: 'kwa (to eat it) — Future',
        headers: ['Person', 'Form', 'Meaning'],
        rows: [
          { person: 'I', form: 'nikkwas', gloss: 'I will eat it' },
          { person: 'you', form: 'tikkwas', gloss: 'you will eat it' },
          { person: 'he / she', form: 'kikwas', gloss: 'he/she will eat it' },
          { person: 'we', form: 'tikkwaskeh', gloss: 'we will eat it' },
          { person: 'they', form: 'kikwaskeh', gloss: 'they will eat it' },
        ],
      },
      {
        kind: 'paradigm',
        heading: 'kwa (to eat it) — Past',
        headers: ['Person', 'Form', 'Meaning'],
        rows: [
          { person: 'I', form: 'nikkwahki', gloss: 'I ate it' },
          { person: 'you', form: 'tikkwahki', gloss: 'you ate it' },
          { person: 'he / she', form: 'kikwahki', gloss: 'he/she ate it' },
          { person: 'we', form: 'tikkwahkeh', gloss: 'we ate it' },
          { person: 'they', form: 'kikwahkeh', gloss: 'they ate it' },
        ],
      },
      {
        kind: 'rule',
        title: 'Pattern summary',
        text: `The core template is:\n\n**[subject: ni-/ti-/in-/ø] + [object: k-/ki-] + [root] + [tense/aspect/plural suffix]**\n\nEHN past stems can be irregular and do not take the Classical ō- augment, so learn attested forms such as *niccōuhqui*, *niyāhqui*, and *nitequitqui* rather than generating them by a single rule.`,
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        rows: [
          ...
          { person: '-toc', form: 'Progressive (right now)', gloss: 'nitequititoc — I am working (right now)' },
          { person: '-qui / -c preterite', form: 'Completed past', gloss: 'nitequitqui — I worked (finished)' },
      ...
      },
      {
        ...
        items: [
          ...
          {
            nahuatl: 'Nitlaxcalchihuatoc.',
            breakdown: 'Ni-tlaxcal-chihua-toc.',
  ...
  },
  {
    ...
    sections: [
      {
        kind: 'prose',
        text: `The Eastern Huasteca word **tlan** means "if." For beginner production, put **tlan** before the condition, then give the result as a second clause. Each clause keeps its own subject prefix.`,
      },
      {
        kind: 'rule',
        title: 'Basic pattern',
        text: `**tlan + condition, result**\n\nUse forms you already know in each clause:\n• Tlan nitequiti, nitlacua. = If I work, I eat.\n• Tlan tiyāuh, niyāuh. = If you go, I go.\n• Tlan tequitih, titequitih. = If they work, we work.`,
      },
      {
        kind: 'examples',
        ...
        items: [
          {
            nahuatl: 'Tlan nitequiti, nitlacua.',
            breakdown: 'tlan ni-tequiti, ni-tlacua',
            translation: 'If I work, I eat.',
            note: 'tlan introduces the condition.',
          },
          {
            nahuatl: 'Tlan tiyāuh, niyāuh.',
            breakdown: 'tlan ti-yāuh, ni-yāuh',
            translation: 'If you go, I go.',
            note: 'Each clause keeps its own subject prefix.',
          },
          {
            nahuatl: 'Tlan tequitih, titequitih.',
            breakdown: 'tlan tequiti-h, ti-tequiti-h',

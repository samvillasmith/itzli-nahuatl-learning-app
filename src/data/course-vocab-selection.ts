...
const UNIT_CARD_ALLOWLISTS = new Map<number, ReadonlySet<number>>([
  ...
  [14, new Set([335, 336, 337, 338, 339, 340, 814002, 814003, 814004, 814005, 814006, 814007])],
  [15, new Set([357, 359, 360, 361, 363, 367, 372, 373, 377, 815002])],
  [16, new Set([381, 815006, 815007, 815009, 816010, 816012])],
